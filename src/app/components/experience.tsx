...
const experiences = [
  {
    ...
    achievements: [
      ...
      "Collaborated on deployment practices to improve release reliability.",
      "Optimized complex user journeys for performance and maintainability.",
    ],
    technologies: [
      "Next.js",
      "React.js",
  ...
  },
  {
    ...
    current: false,
    description:
      "Built an internal assessment platform for a South African company, combining a Next.js frontend with a Node.js backend, PostgreSQL database, and AWS deployment pipeline.",
    achievements: [
      "Delivered a full-stack assessment tool with secure authentication.",
      "Built backend APIs and database schemas for structured business data.",
  ...
  },
  {
    ...
    current: false,
    description:
      "Built and maintained React Native mobile apps while collaborating on the backend architecture, Django REST services, PostgreSQL, AWS deployment, and API integration for the Safi platform.",
    achievements: [
      "Delivered React Native apps integrated with Django REST APIs.",
      "Worked on backend service design for Safi and Safizen.",
      "Implemented secure payment and booking flows with Stripe.",
      "Contributed to deployment and cloud integration best practices.",
      "Supported cross-functional product and QA collaboration.",
    ],
    technologies: [
      "React Native",
      "Django REST",
